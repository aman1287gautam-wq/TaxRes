...
# Enter password to access Section 6 compliance tool
# 
# """, unsafe_allow_html=True)
...
assume_missing_days = 365
assume_status = "Resident Ordinarily Resident (ROR)"
...
        href = f'<a href="data:file/txt;base64,{b64}" download="Tax_Residency_Report_{datetime.now().strftime("%Y%m%d")}.txt">Download Report'
